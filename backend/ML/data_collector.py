...
class MLDataCollector:
    ...
    async def _extract_enhanced_features(self, symbol: str, market_data: Dict, timestamp: float) -> Optional[
        Dict[str, float]]:
        ...
        try:
            ...
            if len(recent_prices) > 10:
                ...
                enhanced_features['price_momentum'] = (prices_array[-1] - prices_array[0]) / prices_array[0] if \
                prices_array[0] > 0 else 0
            ...
            if len(recent_prices) > 20:
                ...
                enhanced_features['sma_ratio'] = prices_array[-1] / np.mean(prices_array[-20:]) if np.mean(
                    prices_array[-20:]) > 0 else 1
                # RSI approximation
